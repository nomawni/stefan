 ...
 */
final class Version20191224171227 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_whish_lists (product_id INT NOT NULL, whish_lists_id INT NOT NULL, INDEX IDX_8B1B5D934584665A (product_id), INDEX IDX_8B1B5D934F0D57CB (whish_lists_id), PRIMARY KEY(product_id, whish_lists_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
