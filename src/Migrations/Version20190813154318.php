 ...
 */
final class Version20190813154318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address ADD phone_number VARCHAR(255) DEFAULT NULL, ADD country VARCHAR(255) NOT NULL, ADD city VARCHAR(255) NOT NULL, ADD street VARCHAR(255) NOT NULL, ADD postal_code VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address DROP phone_number, DROP country, DROP city, DROP street, DROP postal_code');
    }
}
